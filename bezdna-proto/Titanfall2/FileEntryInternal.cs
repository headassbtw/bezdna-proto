...
{
    // TODO: make less internal class for better vis and GUI templating
    public class FileEntryInternal
    {
        ...
        public ushort Unk28 { get; private set; }
        public ushort Unk2a { get; private set; }

        public uint Unk2c { get; private set; }
        ...
        public FileEntryInternal(BinaryReader reader)
        {
            ...
            Unk2a = reader.ReadUInt16();

            Unk2c = reader.ReadUInt32();
